...
enum enMainMenueOptions {
	...
	Update = 4, Find = 5,Transactions = 6, Exit = 7
};
...
void ShowMainMenue();
void ShowTransactionMainMenue(vector <stClient>);
...
void WhatToDo(enMainMenueOptions Option) {
	...
	case enMainMenueOptions::Transactions:
		system("cls");
		ShowTransactionMainMenue(vClients);
		break;
	case enMainMenueOptions::Exit:
		system("cls");
...
void GoBackToTransactionMainMenue(vector <stClient> vClients) {
...
void WhatToDo_Transation(enTranactionsOptions Option, vector <stClient> vClients) {
	switch (Option) {
	case enTranactionsOptions::Deposit:
		system("cls");
		DepositScreen(vClients);
		GoBackToTransactionMainMenue(vClients);
		break;
	case enTranactionsOptions::Withdraw:
		system("cls");
...
void ShowTransactionMainMenue(vector <stClient> vClients) {
	system("cls");
	cout << "===========================================\n";
	...
	cout << "\t[4] Main Menue.\n";
	cout << "===========================================\n";
	WhatToDo_Transation(ReadTransationOption(), vClients);
}
