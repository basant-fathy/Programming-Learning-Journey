# Practical Projects (C++) - Course 05

Two full projects were implemented using **C++**:

## 📌 Included Projects Notice

Some projects in this repository are copied from their original standalone repositories for learning documentation purposes.

## 💻 **Rock-Paper-Scissors Game**
  - 📌 original repository: [Stone-Paper-Scissor](https://github.com/basant-fathy/Stone-Paper-Scissors)
...
## 💻 **Math Quiz Game**
   - 📌 original repository: [Math Game](https://github.com/basant-fathy/Math-Game)
